...
public class ActivityProfile extends AppCompatActivity {
    ...
    public MyAdapterProfile myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Variables.order = new ArrayList<>();
        for (int i = 0 ; i < Variables.productSeller.size() ; i++) if( Variables.productSeller.get(i).equals(Variables.mAuth.getUid())) Variables.order.add(i);

        FloatingActionButton backButton = (FloatingActionButton)this.findViewById(R.id.floatingActionButtonBack4);
        ...
        recycle = findViewById(R.id.recyclerProfile);


        myAdapter = new MyAdapterProfile(getApplicationContext(), this::onFruitClick);
    ...
    public void onFruitClick(int position) {
        Intent activityIntent = new Intent(getApplicationContext(), ActivityStock.class);
        position = Variables.order.get(position);
